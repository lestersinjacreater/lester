...
const ShapeBlur: FC<ShapeBlurProps> = ({
  ...
  useEffect(() => {
    ...
    // Vectors for mouse position, damped mouse position, and resolution
    ...
    // Create a plane geometry and shader material
    ...
    // ResizeObserver to observe changes to the size of the container
